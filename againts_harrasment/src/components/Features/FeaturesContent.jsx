...
import Ruangaman from "../../assets/gambar/healthicons_group-discussion-meetingx3.png"
      ...
      <Container className="mt-5 mb-5" >
        <Row style={{marginBottom: '15vh'}}>
          ...
          <Col md={6} className="text-center mt-5">
            <div style={{ backgroundColor: '#FAD9EC', padding: '20px', textAlign: 'center', borderRadius: '30px' }}>
              <div>
                <img src={Ruangaman} alt="" className="img-fluid mx-auto d-block" />
              </div>
              <div style={{ marginTop: '20px' }}>
                <h5><strong>Ruang Aman</strong></h5>
                <p style={{ textAlign: 'center' }}>Bergabunglah dengan Kami dalam Membangun Ruang Aman dengan Berbagi Ceritamu</p>
                <Link to="/SafeRoom"><Button  variant="secondary" style={{backgroundColor: '#632B50'}} className="mt-3">Cek disini</Button></Link>
              </div>
            </div>
          </Col>
        </Row>
